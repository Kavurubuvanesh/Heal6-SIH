  ...
  return (
    <div className="spotlight-card glass-panel-luxury rounded-3xl p-6 border border-slate-200/80 dark:border-white/10 shadow-xl flex flex-col justify-between gap-5 transition-all h-full w-full relative overflow-hidden group">
      ...
      <div className="flex flex-col gap-2.5">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-2xl bg-[#aceba7]/15 text-[#12464e] dark:text-[#aceba7] flex items-center justify-center font-bold border border-[#aceba7]/30 shadow-inner">
          ...
          <div className="flex items-center gap-2">
            <span className="text-[11px] font-mono font-bold text-[#12464e] dark:text-[#aceba7] bg-[#aceba7]/20 dark:bg-[#aceba7]/10 px-3 py-1 rounded-full border border-[#aceba7]/30">
        ...
        {/* Safety Alert Strip */}
        <div className="bg-[#aceba7]/10 dark:bg-[#12464e]/30 border border-[#aceba7]/30 dark:border-[#aceba7]/20 rounded-2xl px-3.5 py-2 flex items-center justify-between gap-2.5">
          <div className="flex items-center gap-2">
            <ShieldCheck className="w-4 h-4 text-[#12464e] dark:text-[#aceba7] shrink-0" />
            <p className="text-[11px] text-slate-800 dark:text-slate-200 font-medium leading-tight">
          ...
          <button
            ...
            className={`text-[10px] font-bold px-3 py-1 rounded-full transition-all flex items-center gap-1 shrink-0 cursor-pointer ${
              alertAcknowledged
                ? 'bg-[#12464e] text-[#aceba7] border border-[#aceba7]/40 shadow-xs'
                : 'bg-[#aceba7] text-[#0e120f] hover:brightness-105 shadow-sm'
            }`}
          >
            <CheckCircle className="w-3 h-3" />
            <span>{alertAcknowledged ? 'Calibrated' : 'Acknowledge'}</span>
          </button>
        </div>
      </div>
      ...
      <div className="bg-slate-50/70 dark:bg-slate-900/60 border border-slate-200/70 dark:border-white/5 rounded-2xl p-4 flex flex-col gap-3 shadow-inner">
        <div className="flex items-center justify-between border-b border-slate-200/60 dark:border-white/5 pb-2">
          ...
          <div className="flex items-center gap-1.5">
            <span className="text-[10.5px] font-bold text-[#12464e] dark:text-[#aceba7] bg-[#aceba7]/15 px-2.5 py-0.5 rounded-full tracking-tight font-mono border border-[#aceba7]/30">
              Score: {sinbadScore}/6
            </span>
            <span
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3.5">
        {/* Metric 1: Wound Area */}
        <div className="spotlight-card bg-white/80 dark:bg-[#0e120f]/80 backdrop-blur-md rounded-2xl p-4 border border-slate-200/80 dark:border-white/5 flex flex-col justify-between shadow-sm transition-all hover:border-[#aceba7]/40">
          <div className="flex items-center justify-between text-slate-500 dark:text-slate-400 mb-1">
            <span className="text-[10px] font-bold uppercase tracking-wider font-mono">Wound Area</span>
            <span className="p-1.5 rounded-xl bg-[#aceba7]/15 text-[#12464e] dark:text-[#aceba7] border border-[#aceba7]/30">
              <Target className="w-3 h-3" />
            </span>
          </div>

          <div className="my-1">
            <div className="text-xl font-bold font-serif-luxury text-slate-900 dark:text-white tracking-tight">
              {woundArea} <span className="text-xs font-sans font-normal text-slate-500">cm²</span>
            </div>
            <p className="text-[10px] font-semibold text-[#12464e] dark:text-[#aceba7] mt-0.5 font-mono">
              Calibrated: {arucoScale} px/cm
            </p>
          </div>

          <div className="pt-2 border-t border-slate-200/60 dark:border-white/5 text-[9.5px] text-slate-400 flex items-center justify-between font-mono">
            <span>Maj: {majorAxis}cm</span>
            <span>Min: {minorAxis}cm</span>
          </div>
        </div>

        {/* Metric 2: Infection Risk */}
        <div className="spotlight-card bg-white/80 dark:bg-[#0e120f]/80 backdrop-blur-md rounded-2xl p-4 border border-slate-200/80 dark:border-white/5 flex flex-col justify-between shadow-sm transition-all hover:border-rose-400/40">
          <div className="flex items-center justify-between text-slate-500 dark:text-slate-400 mb-1">
            <span className="text-[10px] font-bold uppercase tracking-wider font-mono">Infection Risk</span>
            <span className="p-1.5 rounded-xl bg-rose-500/10 text-rose-500 dark:text-rose-400 border border-rose-500/20">
          ...
          <div className="flex items-center justify-between my-1">
            <div className="flex flex-col">
              <div className="text-xl font-bold font-serif-luxury text-rose-600 dark:text-rose-400 tracking-tight">
                {infectionRisk}%
              </div>
            ...
            <div className="relative w-10 h-10 flex items-center justify-center shrink-0">
              <div className="absolute inset-0 rounded-full border border-dashed border-rose-400/30 animate-orbit-slow pointer-events-none" />
              <svg className="w-10 h-10 transform -rotate-90" viewBox="0 0 66 66">
                <circle
                  cx="33"
                  cy="33"
                  r={radius}
              ...
              <span className="absolute text-[9px] font-bold font-mono text-slate-800 dark:text-slate-100">
                {Math.round(infectionRisk)}%
              </span>
            </div>
          </div>

          <div className="pt-2 border-t border-slate-200/60 dark:border-white/5 text-[9.5px] text-slate-400 font-mono">
            ConvNeXt Gatekeeper
          </div>
        </div>
        ...
        <div className="spotlight-card bg-white/80 dark:bg-[#0e120f]/80 backdrop-blur-md rounded-2xl p-4 border border-slate-200/80 dark:border-white/5 flex flex-col justify-between shadow-sm transition-all hover:border-[#aceba7]/40">
          <div className="flex items-center justify-between text-slate-500 dark:text-slate-400 mb-1">
            <span className="text-[10px] font-bold uppercase tracking-wider font-mono">UNet++ SOTA</span>
            <span className="p-1.5 rounded-xl bg-[#aceba7]/15 text-[#12464e] dark:text-[#aceba7] border border-[#aceba7]/30">
          ...
          <div className="my-1">
            <div className="text-[11px] font-bold text-slate-800 dark:text-slate-200 flex items-center justify-between">
              <div className="flex items-center gap-1.5">
                ...
                <span className="font-serif-luxury font-medium">Tissue Segments</span>
              </div>
              <span className="text-[9.5px] font-mono text-[#12464e] dark:text-[#aceba7] font-bold">EffNet-B4</span>
            </div>

            {/* Multi-segmented 4-class tissue bar */}
            <div className="w-full h-2 rounded-full bg-slate-200 dark:bg-slate-800 flex overflow-hidden mt-2 border border-slate-300 dark:border-white/10 shadow-inner">
              <div
          ...
          <div className="pt-2 border-t border-slate-200/60 dark:border-white/5 text-[9px] text-slate-500 dark:text-slate-400 flex items-center justify-between font-mono font-bold">
      ...
      <div className="grid grid-cols-2 gap-3 pt-1">
        <button
          ...
          className="w-full py-3 px-4 rounded-2xl bg-[#12464e] hover:bg-[#12464e]/90 text-white font-bold text-xs flex items-center justify-center gap-2 transition-all border border-[#aceba7]/30 shadow-lg shadow-[#12464e]/20 cursor-pointer group/btn"
        >
          <FileText className="w-4 h-4 text-[#aceba7] transition-transform group-hover/btn:scale-110" />
          <span className="font-serif-luxury tracking-wide text-sm text-[#aceba7]">Clinical Report</span>
        </button>

        <button
          onClick={onGenerateReferral}
          className="w-full py-3 px-4 rounded-2xl bg-gradient-to-r from-rose-600 to-rose-700 hover:from-rose-500 hover:to-rose-600 text-white font-bold text-xs flex items-center justify-center gap-2 transition-all shadow-lg shadow-rose-900/20 cursor-pointer group/btn border border-rose-400/30"
        >
          <Siren className="w-4 h-4 transition-transform group-hover/btn:rotate-12" />
