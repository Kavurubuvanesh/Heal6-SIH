    ...
    <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-4 overflow-y-auto animate-fadeIn">
      <div className="bg-white dark:bg-[#0c1524]/85 backdrop-blur-xl rounded-2xl max-w-2xl w-full border border-slate-200 dark:border-slate-800 shadow-2xl overflow-hidden flex flex-col my-8">
        ...
        <div className="bg-slate-900 dark:bg-[#070e14] text-white px-6 py-4 flex items-center justify-between border-b border-slate-800">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-3 py-1.5 rounded-lg bg-teal-950/80 hover:bg-teal-900/80 text-teal-300 border border-teal-800/80 text-xs font-semibold flex items-center gap-1.5 transition-colors cursor-pointer"
              title="Export standard HL7 FHIR Release 4 Document Bundle"
            >
        ...
        <div className="bg-slate-50 dark:bg-slate-800/80 px-6 py-4 border-t border-slate-200 dark:border-slate-800 flex items-center justify-between gap-3">
          <button
            onClick={() => setIsFhirModalOpen(true)}
            className="px-4 py-2 text-xs font-bold text-teal-700 dark:text-teal-300 bg-teal-50 dark:bg-teal-950/80 hover:bg-teal-100 dark:hover:bg-teal-900/80 border border-teal-200 dark:border-teal-800/80 rounded-xl transition-colors flex items-center gap-1.5 cursor-pointer"
          >
            <Network className="w-4 h-4 text-teal-600 dark:text-teal-400" />
            <span>HL7 / FHIR R4 Export</span>
          </button>
      ...
      {/* Embedded HL7 FHIR R4 Interoperability Modal */}
      <FhirExportModal
